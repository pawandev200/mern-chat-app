...
// function that keep track of inputed values, store values using eventhadler and pass it to form after submission 
const SignUp = () => {
	...
	const { loading, signup } = useSignup();  // initializing 

	// function to hadle changes of gender and store it 
	const handleCheckboxChange = (gender) => {
		setInputs({ ...inputs, gender });
	};
//  function to handle the form after clicking signup(submit) button
	const handleSubmit = async (e) => {
		e.preventDefault();
		await signup(inputs);  // passing input value for signup 
	};
